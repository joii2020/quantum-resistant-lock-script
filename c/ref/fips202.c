...
#ifdef CKB_VM
void riscv_keccak_f1600(uint64_t *state, uint64_t *stack_buf, uint64_t* rc, int round);
#endif
...
#define Asu state[24]
  ...
  uint64_t stack_buf[5 * 7] = {0};

#define BCa stack_buf[0]
#define BCe stack_buf[1]
#define BCi stack_buf[2]
#define BCo stack_buf[3]
#define BCu stack_buf[4]

#define Da stack_buf[5]
#define De stack_buf[6]
#define Di stack_buf[7]
#define Do stack_buf[8]
#define Du stack_buf[9]

#define Eba stack_buf[10]
#define Ebe stack_buf[11]
#define Ebi stack_buf[12]
#define Ebo stack_buf[13]
#define Ebu stack_buf[14]

#define Ega stack_buf[15]
#define Ege stack_buf[16]
#define Egi stack_buf[17]
#define Ego stack_buf[18]
#define Egu stack_buf[19]

#define Eka stack_buf[20]
#define Eke stack_buf[21]
#define Eki stack_buf[22]
#define Eko stack_buf[23]
#define Eku stack_buf[24]

#define Ema stack_buf[25]
#define Eme stack_buf[26]
#define Emi stack_buf[27]
#define Emo stack_buf[28]
#define Emu stack_buf[29]

#define Esa stack_buf[30]
#define Ese stack_buf[31]
#define Esi stack_buf[32]
#define Eso stack_buf[33]
#define Esu stack_buf[34]
#else   // CKB_VM
...
#ifdef CKB_VM
    riscv_keccak_f1600(state, stack_buf, (uint64_t*)KeccakF_RoundConstants, round);
#endif
...
void sha3_256_inc_init(uint64_t *s_inc) { keccak_inc_init(s_inc); }
...
void sha3_512_inc_init(uint64_t *s_inc) { keccak_inc_init(s_inc); }
